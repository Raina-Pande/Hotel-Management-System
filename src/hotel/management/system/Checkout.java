...
public class Checkout extends JFrame implements ActionListener {
    ...
    Checkout() {
        ...
        Image i5 = i4.getImage().getScaledInstance(400, 235,Image.SCALE_DEFAULT);
        ImageIcon i6 = new ImageIcon(i5);
        JLabel image = new JLabel(i6);
        image.setBounds(350,64,400,250);
        add(image);
        ...
        checkout.setBounds(40, 280,120,30);
